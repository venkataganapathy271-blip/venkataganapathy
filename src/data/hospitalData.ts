...
export const HOSPITAL_STATS = [
  { label: "Years of Service", value: "14+", description: "Serving Hanuman Junction & surrounding areas" },
  { label: "Established", value: "2014", description: "Serving patients since 2014" },
...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    fullDesc: "Head consultant Dr. Maruthi Rao Pulavarthi holds a P.G. Diploma in Sports Rehab, providing expert treatment for muscle tears, sprains, elbow stiffness, and sports conditioning.",
    iconName: "Activity",
    ...
    doctorInCharge: "Dr. Maruthi Rao Pulavarthi (B.P.T, )",
  },
];
...
export const FACILITIES: Facility[] = [
  ...
  {
    id: "fac-2",
    title: "Laser Pain Management",
    description: "Advanced laser therapy for targeted, deep tissue pain relief and accelerated healing.",
    category: "Therapy",
    icon: "Layers",
    image: "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&q=80&w=800",
  ...
  },
  {
    ...
    description: "Dedicated exercise area for step-by-step joint mobilization, parallel bar walking, and joint range of motion.",
...
export const SYMPTOM_OPTIONS: SymptomOption[] = [
  {
    ...
    suggestedSpecialist: "Dr. Maruthi Rao Pulavarthi",
  },
  {
    id: "sym-2",
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 5,
    comment: "I was suffering from severe lower back pain and sciatica leg numbness. Dr. Maruthi Rao Pulavarthi garu treated me at Hanuman Junction clinic with digital traction and exercises. I am completely pain-free now!",
  ...
  },
  {
    ...
    rating: 5,
    comment: "After my knee replacement surgery, my joint was very stiff. Dr. Maruthi Rao Pulavarthi's post-operative mobilization helped me walk normally again without any support.",
    doctorName: "Dr. Maruthi Rao Pulavarthi",
  ...
  },
  {
    ...
    rating: 5,
    comment: "My right side leg and hand lost movement after stroke. Thanks to 14+ years experienced Dr. Maruthi Rao Pulavarthi's daily paralysis rehab, I am able to walk independently today.",
    doctorName: "Dr. Maruthi Rao Pulavarthi",
